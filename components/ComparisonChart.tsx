...
export function ComparisonChart({
    ...
    if (mode === 'line') {
        const data = Array.from({ length: horizon }, (_, i) => {
            ...
            results.forEach(r => {
                entry[r.name] = r.yearly[i].cumulativeTotal;
            });
            return entry;
        });
        return (
    ...
    if (mode === 'pie') {
        ...
        const pieData = [
            ...
            { name: 'Loan', value: focus.totalLoanPayments },
            {
                ...
                value:
                    focus.totalCost -
                    (focus.totalFuelOrElectricity +
                        focus.totalMaintenance +
                        focus.totalLoanPayments -
                        focus.resaleOffset),
            },
        ];
        return (

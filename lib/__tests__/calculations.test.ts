...
describe('compare calculations', () => {
  it('basic ICE vs EV scenario', () => {
    const vehicles: Vehicle[] = [
      { id: 'ice1', name: 'Honda Freed', type: 'ICE', purchasePrice: 600000, fuelPricePerLiter: 30, fuelEfficiencyKmPerLiter: 12, monthlyKm: 1000 },
      { id: 'ev1', name: 'MG4', type: 'EV', purchasePrice: 709900, electricityPricePerKwh: 5.5, energyConsumptionKwhPer100km: 13.5, monthlyKm: 1000 }
    ];
